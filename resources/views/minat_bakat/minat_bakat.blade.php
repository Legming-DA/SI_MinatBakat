@extends('layouts.app')
@section('title', 'Data Minat-Bakat')
        ...
        <div class="card">
          <div class="card-header">
            ...
            <div class="button-container">
              <a href="{{ route('minat_bakat.create') }}" class="btn btn-dark btn-sm">
                <i class="fa fa-plus-square mr-1" aria-hidden="true"></i>
                Add
              </a>
              <a href="{{ route('minat_bakat.cetak') }}" class="btn btn-warning btn-sm">
          ...
          @if(session('success'))
            ...
            <table id="example1" class="table table-bordered table-striped">
              <thead>
                <tr>
                  <th class="sorting sorting_asc">Kode MB</th>
                  <th>Jenis MB</th>
                  <th>Deskripsi</th>
                  <th>Action</th>
                </tr>
                ...
                <tr>
                  ...
                  <td>
                    <div class="text-center">
                      <a href="{{ route ('minat_bakat.edit', ['minat_bakat' => $data->kd_minatbakat]) }}">
                        <button type="button" class="btn btn-success btn-xs d-inline-block">
                        <i class="fas fa-edit mr-1"></i>Edit</button>
                      </a>
                      <form action="{{ route('minat_bakat.destroy', $data->kd_minatbakat) }}" method="POST" style="display: inline;">
                        @csrf
                        @method('DELETE')
