      ...
      <div class="card card-info card-outline">
        ...
        <div class="card-header">
            ...
            <div class="button-container">
              <a href="{{ route('aturan.create') }}" class="btn btn-dark btn-sm">
                <i class="fa fa-plus-square mr-1" aria-hidden="true"></i>
                Add
              </a>
              <a href="{{ route('aturan.cetak') }}" class="btn btn-warning btn-sm">
          ...
          <div class="card-body">
            <table id="example1" class="table table-bordered table-striped">
              <thead>
                <tr>
                  <th class="sorting sorting_asc">Kode Aturan</th>
                  <th>Indikator</th>
                  <th>Minat-Bakat</th>
                  <th>Hasil Aturan</th>
                </tr>
                ...
                <tr>
                  ...
                  <td>
                    <div class="text-center">
                      <a href="{{ route ('aturan.edit', ['aturan' => $data->kd_aturan]) }}">
                        <button type="button" class="btn btn-success btn-xs d-inline-block">
                        <i class="fas fa-edit mr-1"></i>Edit</button>
                      </a>
                      <form action="{{ route('aturan.destroy', $data->kd_aturan) }}" method="POST" style="display: inline;">
                        @csrf
                        @method('DELETE')
