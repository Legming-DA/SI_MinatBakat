    ...
    <div class="col-md-12">
      <div class="card card-info card-outline">
        ...
        <div class="card-header">
            ...
            <a href="{{ route ('indikator_mb.create') }}" class="btn btn-dark btn-sm float-left">
          ...
          @if(session('success'))
            ...
            <table id="example1" class="table table-bordered table-striped">
              <thead>
                <tr>
                  <th class="sorting sorting_asc">Kode Indikator</th>
                ...
                <tr>
                  ...
                  <td>
                    <div class="text-center">
                      <a href="{{ route ('indikator_mb.edit', ['indikator_mb' => $data->kd_indikator]) }}">
                        <button type="button" class="btn btn-success btn-xs d-inline-block">
                        <i class="fas fa-edit mr-1"></i>Edit</button>
                      </a>
                      <form action="{{ route('indikator_mb.destroy', $data->kd_indikator) }}" method="POST" style="display: inline;">
                        @csrf
                        @method('DELETE')
