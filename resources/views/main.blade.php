...
<head>
  ...
  <title>ADMIN Minat-Bakat | Dashboard</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ asset('/') }}index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">PickOurChoice</span>
    </a>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2023 <a href="https://adminlte.io">Teman Talents</a>.</strong> All rights reserved.
  </footer>
