    ...
    <div class="col-md-12">
      <div class="card card-info card-outline">
        ...
        <div class="card-header">
            ...
            <a href="{{ route ('pengguna.create') }}" class="btn btn-dark btn-sm float-left">
                ...
                <tr>
                  ...
                  <td>
                    <div class="text-center">
                      <a href="{{ route ('pengguna.edit', ['pengguna' => $data->id_pengguna]) }}">
                        <button type="button" class="btn btn-success btn-xs d-inline-block">
                        <i class="fas fa-edit mr-1"></i>Edit</button>
                      </a>
                      <form action="{{ route('pengguna.destroy', $data->id_pengguna) }}" method="POST" style="display: inline;">
                        @csrf
                        @method('DELETE')
