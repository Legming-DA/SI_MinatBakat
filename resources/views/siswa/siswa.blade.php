        ...
        <div class="card">
          <div class="card-header">
            ...
            <div class="button-container">
              <a href="{{ route('siswa.create') }}" class="btn btn-dark btn-sm">
                <i class="fa fa-plus-square mr-1" aria-hidden="true"></i>
                Add
              </a>
              <a href="{{ route('siswa.cetak') }}" class="btn btn-warning btn-sm">
          ...
          <div class="card-body">
            ...
            <table id="tbsiswa" class="table table-bordered table-striped">
              <thead>
                <tr>
                  <th class="sorting sorting_asc">NISN</th>
                  <th>Nama</th>
                  <th>Jenis Kelamin</th>
                  <th>Usia</th>
                  <th>Email</th>
                ...
                <tr>
                  ...
                  <td>
                    <div class="text-center">
                      <a href="{{ route ('siswa.edit', ['siswa' => $data->nisn]) }}">
                        <button type="button" class="btn btn-success btn-xs d-inline-block">
                          <i class="fas fa-edit mr-1"></i>Edit</button>
                      </a>
                      <form action="{{ route('siswa.destroy', $data->nisn) }}" method="POST" style="display: inline;">
                        @csrf
                        @method('DELETE')
