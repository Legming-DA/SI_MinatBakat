      ...
      <div class="card card-info card-outline">
        ...
        <div class="card-header">
            ...
            <div class="button-container">
              <a href="{{ route('jurusan.create') }}" class="btn btn-dark btn-sm">
                <i class="fa fa-plus-square mr-1" aria-hidden="true"></i>
                Add
              </a>
              <a href="{{ route('jurusan.cetak') }}" class="btn btn-warning btn-sm">
          ...
          @if(session('success'))
            ...
            <table id="example1" class="table table-bordered table-striped">
              <thead>
                <tr>
                  <th class="sorting sorting_asc">Kode Jurusan</th>
                ...
                <tr>
                  ...
                  <td>
                    <div class="text-center">
                      <a href="{{ route ('jurusan.edit', ['jurusan' => $data->kd_jurusan]) }}">
                        <button type="button" class="btn btn-success btn-xs d-inline-block">
                        <i class="fas fa-edit mr-1"></i>Edit</button>
                      </a>
                      <form action="{{ route('jurusan.destroy', $data->kd_jurusan) }}" method="POST" style="display: inline;">
                        @csrf
                        @method('DELETE')
