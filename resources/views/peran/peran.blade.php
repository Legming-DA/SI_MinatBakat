...
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="font-weight-bold">Data Peran</h1>
      </div>
      <div class="col-sm-6">
      ...
      <div class="card card-info card-outline">
        <div class="card">
          <div class="card-header">
            ...
            <a href="{{ route ('peran.create') }}" class="btn btn-dark btn-sm float-left">
          ...
          @if(session('success'))
            ...
            <table id="example1" class="table table-bordered table-striped">
              <thead>
                <tr>
                  <th class="sorting sorting_asc">Kode Peran</th>
                  <th>Nama Peran</th>
                  <th>Action</th>
                </tr>
              </thead>
                ...
                <tr>
                  ...
                  <td>
                    <div class="text-center">
                      <a href="{{ route ('peran.edit', ['peran' => $data->kd_peran]) }}">
                        <button type="button" class="btn btn-success btn-xs d-inline-block">
                        <i class="fas fa-edit mr-1"></i>Edit</button>
                      </a>
                      <form action="{{ route('peran.destroy', $data->kd_peran) }}" method="POST" style="display: inline;">
                        @csrf
                        @method('DELETE')
